...
- On your PC, simulating the I2C / SPI / GPIO / UART interface objects of ESP32 / Raspberry, in order to develop the peripheral device drivers in the [PyCharm](https://www.jetbrains.com/pycharm/) environment, you can [ set breakpoints and inspect variables easily](https://youtu.be/rhYNySJQ0Rg). 
