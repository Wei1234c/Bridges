...
- 在 PC上模擬 ESP32 / Raspberry 的 I2C/SPI/GPIO/UART介面物件，以便在 [PyCharm](https://www.jetbrains.com/pycharm/) 的環境下開發 周邊裝置的驅動程式，可以 [設定中斷點 並隨時 檢視變數值](https://youtu.be/rhYNySJQ0Rg)。
